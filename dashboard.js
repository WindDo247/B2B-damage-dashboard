...
function renderDashboardCharts() {
    ...
    createChart('clientChart', 'bar', {
        labels: clients,
        datasets: [{ label: 'Đơn Damage', data: clientData, backgroundColor: '#2dd4bf', borderRadius: 4 }]
    ...
    createChart('pickupClientChart', 'bar', {
        ...
        datasets: [{ label: 'Đơn Lấy', data: sortedPickupClients.map(c => c[1]), backgroundColor: '#388ef5', borderRadius: 4 }]
